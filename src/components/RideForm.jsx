  ...
  return (
    <div className="card-ui">
      ...
      <form onSubmit={onSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
        <input type="text" name="motorista" placeholder="Teu Nome" value={formData.motorista} onChange={onFormChange} required className="styled-input" />
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        .styled-input { width: 100%; padding: 10px; border-radius: 8px; border: 1px solid #cbd5e1; background: white !important; color: #1e293b !important; box-sizing: border-box; }
        .btn-submit { background: #4f46e5; color: white; border: none; padding: 12px; border-radius: 10px; font-weight: bold; cursor: pointer; }
      ` }} />
    </div>
  );
}
